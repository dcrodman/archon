...
var file_api_proto_rawDesc = []byte{
	...
	0x08, 0x53, 0x68, 0x69, 0x70, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x28, 0x0a, 0x05, 0x73, 0x68, 0x69,
	0x70, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x53,
	0x68, 0x69, 0x70, 0x4c, 0x69, 0x73, 0x74, 0x2e, 0x53, 0x68, 0x69, 0x70, 0x52, 0x05, 0x73, 0x68,
	0x69, 0x70, 0x73, 0x1a, 0x3e, 0x0a, 0x04, 0x53, 0x68, 0x69, 0x70, 0x12, 0x12, 0x0a, 0x04, 0x6e,
	...
	0x6f, 0x72, 0x74, 0x32, 0x46, 0x0a, 0x0b, 0x53, 0x68, 0x69, 0x70, 0x53, 0x65, 0x72, 0x76, 0x69,
	0x63, 0x65, 0x12, 0x37, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x41, 0x63, 0x74, 0x69, 0x76, 0x65, 0x53,
	0x68, 0x69, 0x70, 0x73, 0x12, 0x16, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x1a, 0x0d, 0x2e, 0x61,
	0x70, 0x69, 0x2e, 0x53, 0x68, 0x69, 0x70, 0x4c, 0x69, 0x73, 0x74, 0x42, 0x07, 0x5a, 0x05, 0x2e,
...
var file_api_proto_depIdxs = []int32{
	...
	2, // 1: api.ShipService.GetActiveShips:input_type -> google.protobuf.Empty
	0, // 2: api.ShipService.GetActiveShips:output_type -> api.ShipList
...
func (c *shipServiceClient) GetActiveShips(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*ShipList, error) {
	out := new(ShipList)
	err := c.cc.Invoke(ctx, "/api.ShipService/GetActiveShips", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedShipServiceServer can be embedded to have forward compatible implementations.
type UnimplementedShipServiceServer struct {
}

func (*UnimplementedShipServiceServer) GetActiveShips(context.Context, *empty.Empty) (*ShipList, error) {
...
func _ShipService_GetActiveShips_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(empty.Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ShipServiceServer).GetActiveShips(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.ShipService/GetActiveShips",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ShipServiceServer).GetActiveShips(ctx, req.(*empty.Empty))
	}
	return interceptor(ctx, in, info, handler)
}

var _ShipService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "api.ShipService",
	HandlerType: (*ShipServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetActiveShips",
			Handler:    _ShipService_GetActiveShips_Handler,
		},
	},
