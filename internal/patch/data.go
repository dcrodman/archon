...
func (s *DataServer) Handle(ctx context.Context, c *client2.Client, data []byte) error {
...
func (s *DataServer) sendWelcomeAck(c *client2.Client) error {
...
func (s *DataServer) handlePatchLogin(c *client2.Client) error {
...
func (s *DataServer) sendDataAck(c *client2.Client) error {
...
func (s *DataServer) sendFileList(c *client2.Client, node *directoryNode) error {
...
func (s *DataServer) sendChangeDir(c *client2.Client, dir string) error {
...
func (s *DataServer) sendCheckFile(c *client2.Client, index uint32, filename string) error {
...
func (s *DataServer) sendDirAbove(c *client2.Client) error {
...
func (s *DataServer) sendFileListDone(c *client2.Client) error {
...
func (s *DataServer) handleFileStatus(c *client2.Client, fileStatus *packets.FileStatus) {
...
func (s *DataServer) updateClientFiles(c *client2.Client) error {
...
func (s *DataServer) sendStartFileUpdate(c *client2.Client, num, totalSize uint32) error {
...
func (s *DataServer) traverseAndUpdate(c *client2.Client, node *directoryNode) error {
...
func (s *DataServer) updateClientFile(c *client2.Client, patch *fileEntry) error {
...
func (s *DataServer) sendFileHeader(c *client2.Client, patch *fileEntry) error {
...
func (s *DataServer) sendFileChunk(c *client2.Client, chunk, chksm, chunkSize uint32, fdata []byte) error {
...
func (s *DataServer) sendFileComplete(c *client2.Client) error {
	return c.Send(packets.PCHeader{Type: packets.PatchFileCompleteType, Size: 0x04})
}

// We've finished updating files.
func (s *DataServer) sendUpdateComplete(c *client2.Client) error {
