...
protoc \
  --proto_path=internal/server/shipgate/api \
  --go_out=internal/server/shipgate/api \
  --go-grpc_out=internal/server/shipgate/api \
  internal/server/shipgate/api/api.proto